def register(runtime):
    ...
    runtime.register('browser://{session}/form/command/submit', 'python://uribrowserdocker.handlers:submit_form', kind='command', operation='browser.form.submit', approval='required', side_effects=True)

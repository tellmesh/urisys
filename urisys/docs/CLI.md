...
```bash
urisys --packs none --markpact urisys/markpacts/packs/uribrowser.markpact.md routes
```
...
```bash
urisys --packs all flow urisys/flows/device-maintenance.uri.flow.yaml --approve --dry-run
```
